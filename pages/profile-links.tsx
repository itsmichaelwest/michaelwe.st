                ...
                <ul>
                    ...
                    <li>
                        ...
                        <Link href="https://mastodon.social/@michaelwest">
                            @michaelwest@mastodon.social
                        </Link>{" "}
                        (profile contains ownership-checked link to this
                        website)
                    </li>
                    <li>
                        Bluesky:{" "}
                        <Link href="https://bsky.app/profile/michaelwest.bsky.social">
                            @michaelwest.bsky.social
                        </Link>
                    </li>
                    <li>
                        Threads:{" "}
                        <Link href="https://www.threads.net/@itsmichaelwest">
                            @itsmichaelwest
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        GitHub:{" "}
                        <Link href="https://github.com/itsmichaelwest">
                            itsmichaelwest
                        </Link>
                    </li>
                    <li>
