...
const NoMSFTDisclaimer: React.FC<NoMSFTDisclaimerProps> = ({ title }) => (
    <div className="bg-gray-50 dark:bg-gray-900 px-8 pb-7 pt-8 mb-16 space-y-2 rounded-2xl shadow-xs ring ring-black/5 dark:ring-white/5">
        <h4 className="text-heading text-xl font-medium flex items-center gap-2">
