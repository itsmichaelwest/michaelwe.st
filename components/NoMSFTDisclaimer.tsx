...
interface NoMSFTDisclaimerProps {
    title: string;
}

const NoMSFTDisclaimer: React.FC<NoMSFTDisclaimerProps> = ({ title }) => (
    <div className="bg-gray-100 dark:bg-gray-900 px-8 pb-2 pt-1 mb-16">
        <div>
            <h4 className="text-gray-900 dark:text-gray-100 text-xl flex flex-row">
            ...
            <p className="text-gray-800 dark:text-gray-200">
                <em>{title}</em> isn&apos;t affiliated with Microsoft. Concepts
                and mockups shown do not represent any product plans past,
                present, or future.
            </p>
        </div>
    </div>
